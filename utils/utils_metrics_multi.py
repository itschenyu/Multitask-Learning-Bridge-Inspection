...
def compute_mIoU(gt_dir_e, pred_dir_e, gt_dir_d, pred_dir_d, png_name_list, num_classes, name_classes=None):  
    ...
    print('===> mIoU_e: ' + str(round(np.nanmean(IoUs_e) * 100, 2)) + '; mPA_e: ' + str(round(np.nanmean(PA_Recall_e) * 100, 2)) + '; Accuracy_e: ' + str(round(per_Accuracy(hist_e) * 100, 2)))  
    print('===> mIoU_d: ' + str(round(np.nanmean(IoUs_d) * 100, 2)) + '; mPA_d: ' + str(round(np.nanmean(PA_Recall_d) * 100, 2)) + '; Accuracy_d: ' + str(round(per_Accuracy(hist_d) * 100, 2)))  
