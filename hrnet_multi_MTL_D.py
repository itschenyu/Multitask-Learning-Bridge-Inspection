...
class HRnet_Segmentation(object):
    ...
    def detect_image(self, image, cross_e, cross_d, count=False, name_classes=None):
        ...
        if self.mix_type == 0:
            ...
            seg_img_d = np.reshape(np.array(self.colors, np.uint8)[np.reshape(pr_d, [-1])], [orininal_h, orininal_w, -1])
